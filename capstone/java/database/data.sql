...
INSERT INTO provider (user_id, first_name, last_name, title) VALUES (2, 'testFirstB', 'testLastB', 'M.D.');

INSERT INTO users (username,password_hash,role) VALUES ('user2', 'password_hash', 'ROLE_USER');
INSERT INTO patient (user_id, first_name, last_name) VALUES (3, 'first', 'last');
...
INSERT INTO appointments (patient_id, provider_id, appointment_date, appt_start_time, appt_end_time) VALUES (1, 1, '2022-10-31', '09:00:00', '09:30:00');
