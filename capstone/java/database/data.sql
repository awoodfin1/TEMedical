...
INSERT INTO patient (user_id, first_name, last_name, phone_number, email_address, birthdate, health_issues_description)
	VALUES
		(100001, 'patientAFirst', 'patientALast', '8005551234', 'first.last@gmail.com', '1994-01-01', 'Insert health issues desc. here');

INSERT INTO users (username,password_hash,role, is_provider)
	VALUES
	('admin','$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC','ROLE_ADMIN', true);
	
INSERT INTO provider (user_id, title, first_name, last_name, post_nominals, gender, language, rating, phone_number, bio, photo_URL)
	VALUES
		(100002, 'Dr.', 'providerAFirst', 'providerALast', 'MD', 'Male', 'English', 4.55, '8009994567', 'Insert provider bio here.', 'https://as2.ftcdn.net/v2/jpg/03/20/52/31/1000_F_320523164_tx7Rdd7I2XDTvvKfz2oRuRpKOPE5z0ni.jpg');
...
INSERT INTO office (office_name, tag_line, street_address, city, "state", zipcode, office_open_time, office_close_time, phone_number, cost_per_hour, has_appt_delay)
	VALUES
