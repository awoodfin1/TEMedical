...
public class JdbcUserDao implements UserDao {
    ...
    @Override
    public boolean create(String username, String password, String role, boolean isProvider) {
        String insertUserSql = "insert into users (username, password_hash, role, is_provider) values (?,?,?,?)";
